...
class Schema {
  constructor(obj, options) {
    ...
    if (this.options.timestamps) {
      ...
      const getISODatetime = () => { return (new Date()).toISOString(); };
      obj[createdAt] = _.merge(obj[createdAt] || {}, {type: Date, default: getISODatetime});
      obj[updatedAt] = _.merge(obj[updatedAt] || {}, {type: Date, default: getISODatetime, set: getISODatetime});
